...
ramsey_test <- summary(lm(residuals_squared ~ household_samplesize + female_edu + mean_age + age_squared + overall_education + median_distance + mean_income_district + bhu_visitation_proportion, regionaldata))
print(ramsey_test)
...
ramsey_test_restricted <- lm(residuals_squared ~ female_edu + mean_age + age_squared + overall_education + median_distance + mean_income_district + bhu_visitation_proportion, regionaldata)
summary(ramsey_test_restricted)
